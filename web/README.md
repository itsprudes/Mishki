...
`img/mishki-bg.png` (2048 × 2048) из макета, положен как в макете:
`background-size: 1920px 1920px` от левого верхнего угла, плюс `fixed`.
Добавлен `repeat` на случай экрана шире 1920 — подложка бесшовная
...
карточки выцветают следом. Поэтому размер задан явным числом.
